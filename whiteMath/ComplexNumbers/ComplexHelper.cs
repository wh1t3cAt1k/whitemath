...
namespace whiteMath
{
    ...
    /// </summary>
        public static class Helper
        {
            ...
            {
                return new Complex(one.RealCounterPart * (two.RealCounterPart - two.ImaginaryCounterPart) + two.ImaginaryCounterPart * (one.RealCounterPart - one.ImaginaryCounterPart),
                    two.ImaginaryCounterPart * (one.RealCounterPart - one.ImaginaryCounterPart) + one.ImaginaryCounterPart * (two.RealCounterPart + two.ImaginaryCounterPart));
            }
        }
    }
}

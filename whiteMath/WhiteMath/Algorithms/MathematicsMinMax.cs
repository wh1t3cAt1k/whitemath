...
namespace WhiteMath.Mathematics
{
    public static partial class Mathematics<T, C> where C : ICalc<T>, new()
    {
        ...
        {
            return (Calculator.GreaterThan(one, two) ? two : one);
        }
        ...
        {
            return Calculator.GetCopy(Min(one, two));
        }
        ...
        {
            return (Calculator.GreaterThan(one, two) ? one : two);
        }
        ...
        {
            return Calculator.GetCopy(Max(one, two));
        }
        ...
        {
            if (Calculator.GreaterThan(Calculator.Zero, number)) return Calculator.Negate(number);

...
using LongInt = WhiteMath.ArithmeticLong.LongInt<WhiteMath.ArithmeticLong.Infrastructure.Precisions.P_50k_10k>;

using Rational = WhiteMath.RationalNumbers.Rational<
	WhiteMath.ArithmeticLong.LongInt<WhiteMath.ArithmeticLong.Infrastructure.Precisions.P_50k_10k>, 
	WhiteMath.Calculators.CalcLongInt<WhiteMath.ArithmeticLong.Infrastructure.Precisions.P_50k_10k>>;
...
namespace WhiteMath.Mathematics
{
    ...
    public static partial class Mathematics<T, C> where C : ICalc<T>, new()
    {
        ...
        public static T PI_Leibnitz(long members)
        {
            ...
            {
                T tmp = Calculator.Divide(Calculator.FromInteger(4), Calculator.FromInteger(i * 2 + 1));
                if ((i % 2) == 0) sum = Calculator.Add(sum, tmp);
                else sum = Calculator.Subtract(sum, tmp);
            }

namespace WhiteMath.ArithmeticLong
{
	...
	{
		public const string DigitBaseNeedsToBeBiggerThanOne = "The digit base should be a positive number larger than 1."; 		
		public const string DigitArrayNeedsToHaveAtLeastOneDigit = "The digits array should contain at least one digit.";
